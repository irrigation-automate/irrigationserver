...
describe('Server Module', () => {
  ...
  describe('startServer', () => {
    it('should start the server successfully with default port', async () => {
      // Mock successful MongoDB connection with default port
    ...
    it('should start the server successfully with custom port', async () => {
      // Mock successful MongoDB connection with custom port
